...
import com.example.to_docompose.di.DatabaseModule_ProvideDaoFactory;
import com.example.to_docompose.di.DatabaseModule_ProvideDatabaseFactory;
import com.example.to_docompose.ui.viewmodels.SharedViewModel;
import com.example.to_docompose.ui.viewmodels.SharedViewModel_HiltModules;
...
public final class DaggerToDoApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends ToDoApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_to_docompose_ui_viewmodels_SharedViewModel, SharedViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_to_docompose_ui_viewmodels_SharedViewModel = "com.example.to_docompose.ui.viewmodels.SharedViewModel";

      @KeepFieldType
      SharedViewModel com_example_to_docompose_ui_viewmodels_SharedViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends ToDoApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.todoRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<TodoRepository>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1));
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_to_docompose_ui_viewmodels_SharedViewModel, ((Provider) sharedViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.to_docompose.ui.viewmodels.SharedViewModel 
          return (T) new SharedViewModel(viewModelCImpl.todoRepositoryProvider.get(), viewModelCImpl.dataStoreRepositoryProvider.get());

          case 1: // com.example.to_docompose.data.repositories.TodoRepository 
          return (T) new TodoRepository(singletonCImpl.provideDaoProvider.get());

          case 2: // com.example.to_docompose.data.repositories.DataStoreRepository 
  ...
  private static final class SingletonCImpl extends ToDoApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<ToDoDatabase>(singletonCImpl, 1));
      this.provideDaoProvider = DoubleCheck.provider(new SwitchingProvider<ToDoDao>(singletonCImpl, 0));
    }
